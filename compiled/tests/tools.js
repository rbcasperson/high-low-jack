...
ava_1.default.beforeEach(`initiate a deck`, t => {
    t.context.deck = new deck_1.Deck();
});
ava_1.default(`whether or not trump has been played can be determined`, t => {
...
ava_1.default(`trick winner can be determined`, t => {
    let cardsToDraw = ['ace of spades', 'king of hearts', '2 of clubs', '2 of spades'];
    let [aceSpades, kingHearts, twoClubs, twoSpades] = t.context.deck.drawSpecificCards(...cardsToDraw);
    let cardsPlayed = {
        'Player 1': aceSpades,
