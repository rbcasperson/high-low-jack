...
import {
  ...
  isValidCardToPlay,
  determineHighPointWinner,
  determineLowPointWinner,
  determineJackPointWinner,
  determineGamePointWinner,
...
test(`the trick winner can be determined - scenario 1`, t => {
  ...
  let leadSuit = "spades";
  let winningPlayerName = determineTrickWinner(
    cardsPlayed,
    trumpSuit,
    leadSuit
  );
...
test(`the winner of the High point can be determined - scenario 1`, t => {
  ...
  teams["Team 1"].cardsWon = [
    getCard("jack of clubs"),
    getCard("ace of clubs")
  ];
...
test(`the winner of the High point can be determined - scenario 3`, t => {
  ...
  teams["Team 2"].cardsWon = [
    getCard("2 of hearts"),
    getCard("ace of hearts"),
    getCard("king of hearts"),
    getCard("jack of hearts")
  ];
