...
const constants_1 = require("./deck/constants");
class Card {
...
exports.Card = Card;
class Deck {
    constructor(suits = constants_1.SUITS, values = constants_1.VALUES, valueRanks = constants_1.VALUE_RANKS, gamePointValues = constants_1.GAME_POINT_VALUES) {
        this.cards = [];
        this.cardsInPlay = [];
        _.each(suits, suit => {
            _.each(values, value => {
...
},{"./deck/constants":2,"lodash":13}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.GAME_POINT_VALUES = exports.VALUE_RANKS = exports.VALUES = exports.SUITS = void 0;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.hasCardWithSuit = exports.removeCard = exports.collect = exports.draw = exports.shuffle = void 0;
const _ = require("lodash");
...
function removeCard(cards, cardName) {
...
function hasCardWithSuit(cards, suit) {
    return _.some(cards, card => {
        return card.suit === suit;
    });
}
exports.hasCardWithSuit = hasCardWithSuit;
...
const tools_1 = require("./match/tools");
const tools_2 = require("./deck/tools");
let defaultSettings = {
    cardsPerPlayer: 6,
    maxBid: 4,
    teams: [
...
class Match {
    constructor(settings = defaultSettings) {
        ...
        _.each(settings.teams, team => {
            this.teams[team.name] = new team_1.Team(team.name, team.players);
            _.each(team.players, playerName => {
                this.players[playerName] = new player_1.Player(playerName, team.name);
            });
        });
    }
    get scores() {
    ...
    deal() {
        this.deck = new deck_1.Deck();
        this.deck.cards = tools_2.shuffle(this.deck.cards);
        _.each(this.players, (player, playerName) => {
            [this.deck, player.hand] = tools_2.draw(this.deck, this.settings.cardsPerPlayer);
        });
    }
    makeBid(playerName, bidAmount) {
        if (tools_1.isValidBid(bidAmount, this.round.bid, this.settings.maxBid)) {
    ...
    playCard(cardName, playerName) {
        if (tools_1.isValidCardToPlay(cardName, this.players[playerName].hand, this.trick.leadSuit, this.round.trumpSuit)) {
            let cardBeingPlayed;
            [this.players[playerName].hand, cardBeingPlayed] = tools_2.removeCard(this.players[playerName].hand, cardName);
    ...
    completeTrick() {
        let winningPlayerName = tools_1.determineTrickWinner(this.trick.cardsPlayed, this.round.trumpSuit, this.trick.leadSuit);
    ...
    completeRound() {
        let pointsEarned = tools_1.determinePointsEarnedForEachTeam(this.teams);
...
},{"./deck":1,"./deck/tools":3,"./match/tools":5,"./player":6,"./team":7,"lodash":13}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.determinePointsEarnedForEachTeam = exports.determineGamePointWinner = exports.determineJackPointWinner = exports.determineLowPointWinner = exports.determineHighPointWinner = exports.determineTrickWinner = exports.isValidCardToPlay = exports.isValidBid = void 0;
const _ = require("lodash");
const tools_1 = require("../deck/tools");
function isValidBid(bidAmount, currentBid, maxBid) {
    return bidAmount > 1 && currentBid.amount < bidAmount && bidAmount <= maxBid;
}
exports.isValidBid = isValidBid;
function isValidCardToPlay(cardName, hand, leadSuit, trumpSuit) {
    if (!leadSuit ||
        _.endsWith(cardName, trumpSuit) ||
        _.endsWith(cardName, leadSuit)) {
        return true;
    }
    return !tools_1.hasCardWithSuit(hand, leadSuit);
}
exports.isValidCardToPlay = isValidCardToPlay;
function _determineTrickWinner(cardsPlayed, winningSuit) {
...
function determineTrickWinner(cardsPlayed, trumpSuit, leadSuit) {
    if (tools_1.hasCardWithSuit(_.values(cardsPlayed), trumpSuit)) {
...
function determineHighPointWinner(teams) {
...
exports.determineHighPointWinner = determineHighPointWinner;
function determineLowPointWinner(teams) {
...
exports.determineLowPointWinner = determineLowPointWinner;
function determineJackPointWinner(teams) {
    let jackWinner = null;
    _.each(teams, (team, teamName) => {
...
exports.determineJackPointWinner = determineJackPointWinner;
function determineGamePointWinner(teams) {
...
exports.determineGamePointWinner = determineGamePointWinner;
function determinePointsEarnedForEachTeam(teams) {
    let pointsEarned = {};
    _.each(teams, (team, teamName) => {
...
exports.determinePointsEarnedForEachTeam = determinePointsEarnedForEachTeam;

},{"../deck/tools":3,"lodash":13}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.SY_VALUES_BY_CARD_SUIT = exports.SX_VALUES_BY_CARD_VALUE = exports.CARD_HEIGHT = exports.CARD_WIDTH = void 0;
exports.CARD_WIDTH = 72;
exports.CARD_HEIGHT = 96;
exports.SX_VALUES_BY_CARD_VALUE = {
    a: exports.CARD_WIDTH * 0 + 1,
    "2": exports.CARD_WIDTH * 1 + 2,
    "3": exports.CARD_WIDTH * 2 + 3,
    "4": exports.CARD_WIDTH * 3 + 4,
    "5": exports.CARD_WIDTH * 4 + 5,
    "6": exports.CARD_WIDTH * 5 + 6,
    "7": exports.CARD_WIDTH * 6 + 7,
    "8": exports.CARD_WIDTH * 7 + 8,
    "9": exports.CARD_WIDTH * 8 + 9,
    "10": exports.CARD_WIDTH * 9 + 10,
    j: exports.CARD_WIDTH * 10 + 11,
    q: exports.CARD_WIDTH * 11 + 12,
    k: exports.CARD_WIDTH * 12 + 13
};
exports.SY_VALUES_BY_CARD_SUIT = {
    c: exports.CARD_HEIGHT * 0 + 1,
    s: exports.CARD_HEIGHT * 1 + 3,
    h: exports.CARD_HEIGHT * 2 + 5,
    d: exports.CARD_HEIGHT * 3 + 7
};

},{}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.removeChildrenFromElement = exports.sortHand = exports.getCardNameByID = exports.getCardIDByName = void 0;
const _ = require("lodash");
function getCardIDByName(card) {
...
exports.getCardNameByID = getCardNameByID;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const match_1 = require("../engine/src/match");
...
let match = new match_1.Match(settings);
let matchHandler = new matchHandler_1.MatchHandler(match);
matchHandler.startRound();

},{"../engine/src/match":4,"./matchHandler":11}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.MatchHandler = void 0;
const _ = require("lodash");
const tools_1 = require("../engine/src/match/tools");
const helpers_1 = require("./helpers");
const seatingArrangement_1 = require("./seatingArrangement");
const constants_1 = require("./constants");
class MatchHandler {
    constructor(match) {
        this.match = match;
        this.currentDealer = _.sample(this.match.players).name;
        this.seatingArrangement = new seatingArrangement_1.SeatingArrangement(this.match.teams);
    ...
    startRound() {
        ...
        _.each(this.match.players, player => {
            player.hand = helpers_1.sortHand(player.hand);
        });
        this.displayScores();
        this.displayPlayers();
        this.displayCards();
    ...
    clearCards() {
        _.each(this.tablePositions, (position, playerName) => {
            helpers_1.removeChildrenFromElement(document.getElementById(position + "Cards"));
            helpers_1.removeChildrenFromElement(document.getElementById(position + "PlayedCard"));
        });
    }
    displayScores() {
    ...
    displayCards() {
        ...
        _.each(this.seatingArrangement.playerOrder, playerName => {
            ...
            _.each(playerObject.hand, card => {
                ...
                canvas.id = helpers_1.getCardIDByName(card);
                canvas.setAttribute("width", constants_1.CARD_WIDTH.toString());
                canvas.setAttribute("height", constants_1.CARD_HEIGHT.toString());
        ...
        _.each(this.match.trick.cardsPlayed, (card, playerName) => {
            ...
            helpers_1.removeChildrenFromElement(placeForCardOnTableDiv);
            let canvas = document.createElement("canvas");
            canvas.id = helpers_1.getCardIDByName(card);
            canvas.setAttribute("width", constants_1.CARD_WIDTH.toString());
            canvas.setAttribute("height", constants_1.CARD_HEIGHT.toString());
    ...
    drawAllCards() {
        ...
        _.each(document.getElementsByTagName("canvas"), canvas => {
            ...
            if (cardsImage instanceof HTMLImageElement) {
                let sX = constants_1.SX_VALUES_BY_CARD_VALUE[value];
                let sY = constants_1.SY_VALUES_BY_CARD_SUIT[suitLetter];
                let sWidth = constants_1.CARD_WIDTH;
                let sHeight = constants_1.CARD_HEIGHT;
                let dX = 0;
                let dY = 0;
                let dWidth = constants_1.CARD_WIDTH;
                let dHeight = constants_1.CARD_HEIGHT;
    ...
    clearActionDiv() {
        helpers_1.removeChildrenFromElement(document.getElementById("action"));
    }
    addTextToActionDiv(text) {
    ...
    collectBidFrom(playerName) {
        ...
        if (playerName == this.currentDealer && !this.match.round.bid.playerName) {
            ...
            validBids = _.filter(_.range(2, this.match.settings.maxBid + 1), bid => {
                return tools_1.isValidBid(bid, this.match.round.bid, this.match.settings.maxBid);
            });
    ...
    requestCardFrom(playerName) {
        ...
        _.each(cardsDiv.getElementsByTagName("canvas"), cardCanvas => {
            cardCanvas.onclick = () => {
                let cardName = helpers_1.getCardNameByID(cardCanvas.id);
...
},{"../engine/src/match/tools":5,"./constants":8,"./helpers":9,"./seatingArrangement":12,"lodash":13}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class SeatingArrangement {
    ...
    getPlayerToTheLeftOf(player) {
        return this.playerInfo[player].playerToLeft;
    }
    getPlayerToTheRightOf(player) {
